...
export declare class ObjectBuilder {
     ...
     */
    omit(keys: string[]): Omit<any, string>;
    /**
     * Omit data from object.
     */
    pick(keys: string[]): Pick<any, string>;
    /**
...
export declare class Json {
     ...
     * ```
     */
    static omit<T extends object = any, K extends keyof T = any>(object: T, keys: K[]): Omit<T, K>;
    /**
     ...
     * ```
     */
    static pick<T extends object = any, K extends keyof T = any>(object: T, keys: K[]): Pick<T, K>;
    /**
