...
export declare class Module {
     ...
     */
    static getWithAlias(module: any | Promise<any>, subAlias: string): Promise<{
        alias: string;
        module: any;
    }>;
    /**
     ...
     */
    static getFromWithAlias(path: string, subAlias: string): Promise<{
        alias: string;
        module: any;
    }>;
    /**
     ...
     * import.
     */
    static safeImport(path: string): Promise<any | null>;
    /**
     * Resolve the module path by meta url and import it.
     */
    static resolve(path: string, meta: string): Promise<any>;
    /**
