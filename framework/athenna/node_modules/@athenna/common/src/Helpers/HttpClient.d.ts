...
export declare class HttpClientBuilder {
     ...
     */
    mergeOptions(options: ReqOptions): HttpClientBuilder;
    /**
     * Execute the request and return as stream.
     */
    stream(options?: ReqOptions): Request;
    /**
     * Execute the request and return paginated data.
     */
    paginate<T = any>(options?: ReqOptions): AsyncIterableIterator<T>;
    /**
     * Execute the request using all the options defined.
     */
    request<T = any>(options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a GET request.
     */
    get<T = any>(url?: string | URL, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a POST request.
     */
    post<T = any>(url?: string | URL, body?: Body, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a PUT request.
     */
    put<T = any>(url?: string | URL, body?: Body, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a PATCH request.
     */
    patch<T = any>(url?: string | URL, body?: Response, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a DELETE request.
     */
    delete<T = any>(url?: string | URL, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a HEAD request.
     */
    head<T = any>(url?: string | URL, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
}
export declare class HttpClient {
     ...
     * Make a GET request.
     */
    static get<T = any>(url?: string | URL, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a POST request.
     */
    static post<T = any>(url?: string | URL, body?: Body, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a PUT request.
     */
    static put<T = any>(url?: string | URL, body?: Body, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a PATCH request.
     */
    static patch<T = any>(url?: string | URL, body?: Body, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a DELETE request.
     */
    static delete<T = any>(url?: string | URL, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
    /**
     * Make a HEAD request.
     */
    static head<T = any>(url?: string | URL, options?: ReqOptions): import("got").CancelableRequest<import("got").Response<T>>;
}
