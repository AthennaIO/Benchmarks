...
export declare class Path {
     ...
     */
    static cron(subPath?: string): string;
    /**
     * Set the directory of cron folder.
     */
    static setCron(directory: string): typeof Path;
    /**
     * Return the schedulers' path of your project.
     */
    static schedulers(subPath?: string): string;
    /**
     * Set the directory of schedulers folder.
     */
    static setSchedulers(directory: string): typeof Path;
    /**
