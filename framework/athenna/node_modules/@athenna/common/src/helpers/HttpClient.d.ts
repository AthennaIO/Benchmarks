...
export declare class HttpClientBuilder {
     ...
     */
    body(key: any, value?: any): HttpClientBuilder;
    /**
     * Set a key value to the request body.
     */
    input(key: string, value: any): HttpClientBuilder;
    /**
     * Execute the given closure only when the value is
     * truthy.
     */
    when<T = any>(value: T, closure: (builder?: HttpClientBuilder, value?: T) => any): HttpClientBuilder;
    /**
     * Set a header at the request.
     */
    header(key: any, value?: any): HttpClientBuilder;
    /**
     ...
     * ```
     */
    searchParams(key: any, value?: any): HttpClientBuilder;
    /**
     * Alias for the searchParams method.
     */
    query(key: any, value?: any): HttpClientBuilder;
    /**
     * Set a query at the request only if is not already
     * defined.
     */
    safeQuery(key: string, value: any): HttpClientBuilder;
    /**
     * Remove a query from the request.
     */
    removeQuery(key: string): HttpClientBuilder;
    /**
     ...
     * Make a POST request.
     */
    post<T = any>(url?: string | URL, options?: Request): Response<T>;
    /**
     * Make a PUT request.
     */
    put<T = any>(url?: string | URL, options?: Request): Response<T>;
    /**
     * Make a PATCH request.
     */
    patch<T = any>(url?: string | URL, options?: Request): Response<T>;
    /**
...
export declare class HttpClient {
     ...
     * Make a POST request.
     */
    static post<T = any>(url?: string | URL, options?: Request): Response<T>;
    /**
     * Make a PUT request.
     */
    static put<T = any>(url?: string | URL, options?: Request): Response<T>;
    /**
     * Make a PATCH request.
     */
    static patch<T = any>(url?: string | URL, options?: Request): Response<T>;
    /**
     * Make a DELETE request.
     */
