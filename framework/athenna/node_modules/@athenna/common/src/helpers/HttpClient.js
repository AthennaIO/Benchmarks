...
export class HttpClientBuilder {
    ...
    removeQuery(key) {
        ...
        this.options.searchParams = Json.omit(this.options.searchParams, [
            key
        ]);
        return this;
    }
...
export class HttpClient {
    ...
    static post(url, options) {
        return this._builder.post(url, options);
    }
    /**
     * Make a PUT request.
     */
    static put(url, options) {
        return this._builder.put(url, options);
    }
    /**
     * Make a PATCH request.
     */
    static patch(url, options) {
        return this._builder.patch(url, options);
    }
    /**
     * Make a DELETE request.
     */
