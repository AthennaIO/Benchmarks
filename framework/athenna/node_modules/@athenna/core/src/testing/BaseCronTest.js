...
export class BaseCronTest {
    ...
    async baseBeforeAll() {
        this.ignite = await new Ignite().load(Path.toHref(Path.bin(`test.${Path.ext()}`)), this.getIgniteOptions());
...
], BaseCronTest.prototype, "baseBeforeAll", null);
__decorate([
    AfterAll(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BaseCronTest.prototype, "baseAfterAll", null);
