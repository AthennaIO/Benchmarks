 ...
 */
import { Question, ListChoiceOptions, ListQuestionOptions, ExpandChoiceOptions, ExpandQuestionOptions, CheckboxChoiceOptions, CheckboxQuestionOptions } from 'inquirer';
export declare class Prompt {
    /**
     * The inquirer prompt API.
     */
    inquirer: import("inquirer").PromptModule;
    /**
     ...
     * ```
     */
    input(msg: string, opts?: Question): Promise<string>;
    /**
     ...
     * ```
     */
    secret(msg: string, opts?: Question): Promise<string>;
    /**
     * Ask a confirmation.
     *
     * @example
     ...
     * ```
     */
    confirm(msg: string, opts?: Question): Promise<boolean>;
    /**
     ...
     * ```
     */
    editor(msg: string, opts?: Question): Promise<string>;
    /**
     ...
     * ```
     */
    list(msg: string, choices: string[] | ListChoiceOptions[], opts?: ListQuestionOptions): Promise<string>;
    /**
     ...
     * ```
     */
    expand(msg: string, choices: ExpandChoiceOptions[], opts?: ExpandQuestionOptions): Promise<string>;
    /**
     ...
     * ```
     */
    checkbox(msg: string, choices: string[] | CheckboxChoiceOptions[], opts?: CheckboxQuestionOptions): Promise<string[]>;
    /**
     ...
     * ```
     */
    raw<T = any>(msg: string, question: Question): Promise<T>;
}
