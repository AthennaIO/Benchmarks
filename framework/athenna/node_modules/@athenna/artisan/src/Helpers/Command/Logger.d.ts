...
import { type Ora, type Options, type PromiseOptions } from 'ora';
...
export declare class Logger extends AthennaLogger {
    constructor();
    /**
     ...
     * ```
     */
    spinner(msgOrOpts?: string | Options): Ora;
    /**
     ...
     * ```
     */
    promiseSpinner<T = any>(promise: any, msgOrOpts?: string | PromiseOptions<T>): Promise<T>;
    /**
     ...
     * ```
     */
    column(data: any[] | Record<string, any>, opts?: columnify.GlobalOptions): void;
    /**
