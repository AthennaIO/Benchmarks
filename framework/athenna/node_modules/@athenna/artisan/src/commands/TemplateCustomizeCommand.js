...
export class TemplateCustomizeCommand extends BaseCommand {
    ...
    async handle() {
        ...
        this.logger.success(`Athenna RC updated: ({dim,yellow} { templates = ${JSON.stringify(templates, null, 2)} })`);
        this.logger.success(`Template files successfully moved to ({yellow} ${this.templatesPath()}) folder`);
    }
    templatesPath() {
