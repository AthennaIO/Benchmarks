 ...
 */
import { type LinkPackageOptions, type InstallPackageOptions } from '@athenna/common';
export declare class Npm {
     ...
     * ```
     */
    link(libraries: string | string[], options?: LinkPackageOptions): Promise<void>;
    /**
     ...
     * ```
     */
    install(libraries: string | string[], options?: InstallPackageOptions): Promise<void>;
}
