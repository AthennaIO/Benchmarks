...
export class MakeCommandCommand extends BaseCommand {
    ...
    async handle() {
        ...
        const file = await this.generator
            ...
            .make();
        this.logger.success(`Command ({yellow} "${file.name}") successfully created.`);
        ...
        this.logger.success(`Athenna RC updated: ({dim,yellow} { commands += "${signature}": "${importPath}" })`);
    }
    /**
     ...
     */
    getDestinationPath() {
        let destination = Config.get('rc.commands.make:command.destination', Path.console('Commands'));
...
], MakeCommandCommand.prototype, "name", void 0);
