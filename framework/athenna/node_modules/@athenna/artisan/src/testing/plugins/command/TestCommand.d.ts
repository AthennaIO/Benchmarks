...
export declare class TestCommand {
     ...
     */
    static artisanPath: string;
    /**
     * Set the artisan file path.
     */
    static setArtisanPath(path: string): typeof TestCommand;
    /**
     ...
     */
    createOutput(output: CommandOutput): TestOutput;
    /**
     * Run the command and return the TestOutput instance
     * to make assertions.
     */
    run(command: string, options?: CallInChildOptions): Promise<TestOutput>;
}
